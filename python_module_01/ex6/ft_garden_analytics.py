...
class Garden:
    ...
    def garden_report(self):
        ...
        for plant in self.plants:
            validate_h = validate_h and validate_h(plant.height)
        ...
        print(f"Height validation test: {validate_h}")
...
class Garden:
    ...
    def garden_report(self):
        ...
        print(f"{all(p.height > 0 for p in self.plants)}")
