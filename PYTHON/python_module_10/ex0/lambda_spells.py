...
if __name__ == "__main__":
    ...
    mages = [{"power": 89}, {"power": 312}, {"power": 212}, {"power": 3102}, {"power": 214542}]
    spells = ["Fireball", "Snowball", "Zap"]

    print("\nTesting artifact sorter...")
    print(f"{artifact[0]['name']} ({artifact_sorter(artifact)[0]['power']} ", end="")
    print(f"power) comes before {artifact[1]['name']} ({artifact_sorter(artifact)[1]['power']} power)")
