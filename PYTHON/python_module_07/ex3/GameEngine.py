...
#         for i in range(5):
#             card = random.choice([factory.create_creature(None),
...
#         for card_name in action["cards_played"]:
...
#         total_damage  = sum(
#             getattr(card, "damage", 0) for card in self.battlefield)
#         return {
#             'turns_simulated': self.turn_count,
#             'strategy_used': "AggressiveStrategy",
#             'total_damage': total_damage,
#             'cards_created':
#             (len(self.battlefield) + len(self.hand) + len(self.deck))
#             }
