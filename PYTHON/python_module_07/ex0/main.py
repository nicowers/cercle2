...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"\nPlaying {creature1.name} ", end="")
        print(f"with {available_mana} mana available:")
        print("Playable:", creature1.is_playable(available_mana))
        print("Play result:", creature1.play(game_state))
        print("Attack result:", creature1.attack_target(creature2))
